...
public class getreviewsbyversion {

    @Test
    public void testGetReviewsByVersion() {
        // 🔹 Load JSON config
        ...
        JSONObject endpoint = json.getJSONObject("getReviewsByVersion");
        ...
        // 🔹 Response output & assertion
        response.prettyPrint();
        assertEquals(response.getStatusCode(), 200, "❌ Failed to fetch reviews for the version.");
    }
}
